...
contract Auction is Pausable {
    ...
    event Bid(address indexed bidder, string prize, uint bidAmount);
    event NewBestBid(address indexed bidder, string prize, uint bidAmount);
    event IgnoredBid(address indexed bidder, string prize, uint bidAmount);
