...
contract MovementHistory {
    ...
    function addMovement(uint256 _amount, string memory _description,  address _to) public {
        _addMovement(_amount, _description, msg.sender, _to);
    }
    
    function _addMovement(uint256 _amount, string memory _description,  address _from, address _to) internal {
